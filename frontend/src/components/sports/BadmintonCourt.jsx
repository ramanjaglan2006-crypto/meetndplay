...
const BadmintonCourt = ({
    ...
    const config = SPORT_CONFIGS.badminton;
    ...
    return (
        <div style={{
            ...
            <div style={{ position: 'absolute', inset: '16px', border: '2px solid rgba(255,255,255,0.75)', borderRadius: '2px', pointerEvents: 'none' }} />
            ...
            {/* Service & Center Court Lines */}
            <div style={{ position: 'absolute', top: '35%', left: '16px', right: '16px', height: '1px', background: 'rgba(255,255,255,0.5)', pointerEvents: 'none' }} />
            <div style={{ position: 'absolute', bottom: '35%', left: '16px', right: '16px', height: '1px', background: 'rgba(255,255,255,0.5)', pointerEvents: 'none' }} />
            <div style={{ position: 'absolute', top: '16px', bottom: '16px', left: '50%', width: '1px', background: 'rgba(255,255,255,0.5)', pointerEvents: 'none' }} />
            ...
            {hoveredParticipant && (
                <div style={{
                    ...
                    <div style={{ fontSize: '0.75rem', color: 'var(--primary, #38bdf8)', fontWeight: 'normal', marginTop: '2px' }}>
                        Badminton · Level {hoveredParticipant.user?.skill_level || 3}
                    </div>
                </div>
            )}
        </div>
